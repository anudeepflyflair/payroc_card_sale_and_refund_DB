...
resource "aws_dynamodb_table" "payroc_card_logs" {
  name         = "payroccardsalelogs"
  billing_mode = "PAY_PER_REQUEST"
...
resource "aws_dynamodb_table" "payroc_refund_logs" {
  name         = "payroccardrefundlogs"
  billing_mode = "PAY_PER_REQUEST"
...
resource "aws_dynamodb_table" "payroc_void_logs" {
  name         = "payroccardvoidlogs"
  billing_mode = "PAY_PER_REQUEST"
